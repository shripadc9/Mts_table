...
import ResultsDisplay from "./ResultDisplay"; // <-- NEW FILE IMPORT
...
const TablePatternInput = () => {
  ...
  const [apiData, setApiData] = useState(null); // ⭐ NEW STATE
  ...
  return (
    <div className="p-4 max-w-xl mx-auto">
      ...
      <h1 className="text-xl font-bold text-center" style={{ color: "#6D0B3E" }}>
        Table Pattern Input
      </h1>
      ...
      <div className="mt-4 flex justify-center gap-3">
        <button className="bg-[#6D0B3E] text-white px-5 py-2 rounded"
      ...
      {/* ⭐ SHOW RESULTS BELOW FULL TABLE */}
      {apiData && (
        <div className="mt-6">
          <ResultsDisplay apiData={apiData} /> {/* PASS RESPONSE HERE */}
        </div>
      )}
